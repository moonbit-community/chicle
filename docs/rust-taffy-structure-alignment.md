...
- Grid container sizing helpers now live in `compute_grid_container_sizing.mbt`, covering used track size summation, definite/auto border-box resolution, and deferred percent-gap rerun decisions outside the main grid orchestration body.
